...
const homeImageAdminRoutes = require("./routes/homeImageAdminRoutes");
const reviewPublicRoutes = require("./routes/reviewPublicRoutes");
...
app.use("/api/admin/home-images", homeImageAdminRoutes);
