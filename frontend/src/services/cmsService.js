...
/**
 * Contenido CMS del inicio (+ homeImages).
 * `cache()` deduplica llamadas en el mismo request RSC
 * (p. ej. SiteAnnouncement + HomePage / secciones).
 */
...
export const getContentPages = cache(async () => {
